...
{
    class SubsurfaceMaterialTest : IState
    {
        ...
        public void Render(double interval)
        {
            if (!inited)
            {
                ...
                mesh = new Mesh(grp, 10000, 10000, "car_0A.k4_stmesh");
                ...
                RenderState = new RenderState(fbuf, new ShaderProgram(ShaderSource.Load(ShaderType.VertexShader, "Graphics/OpenGL/Shaders/Default/vertex.glsl"), ShaderSource.Load(ShaderType.FragmentShader, "Graphics/OpenGL/Shaders/Default/fragment.glsl")), new ShaderStorageBuffer[] { transforms }, new UniformBuffer[] { mats }, true, true, DepthFunc.Greater, 1, -1, BlendFactor.One, BlendFactor.Zero, Vector4.One, 0, CullFaceMode.Back);
            ...
            //TODO: compute terrain properties using planet gravity, temperature distribution and age
            //temperature depends on star, rotation, orbit, inclination, neighbors, star stability, atmosphere, age, type
            //planets without atmospheres have harsher temperature differences

            //terrain coloring depends on material distribution, terrain shape depends on material properties and temperature.
