...
namespace Kokoro.Engine.Graphics
{
    public class VoxelRayCaster
    {
        ...
        public VoxelRayCaster(int w, int h, Texture data, MeshGroup grp, params Framebuffer[] fbufs)
        {
            ...
            frontFaceState = new RenderState(frontFaceFB, new ShaderProgram(ShaderSource.Load(ShaderType.VertexShader, "Shaders/VolumeRayCast/vertex.glsl"), ShaderSource.Load(ShaderType.FragmentShader, "Shaders/VolumeRayCast/fragment.glsl")), null, null, false, true, DepthFunc.Always, 1, 0, BlendFactor.One, BlendFactor.Zero, Vector4.Zero, 0, CullFaceMode.Back);
            ...
            backFaceState = new RenderState(backFaceFB, new ShaderProgram(ShaderSource.Load(ShaderType.VertexShader, "Shaders/VolumeRayCast/vertex.glsl"), ShaderSource.Load(ShaderType.FragmentShader, "Shaders/VolumeRayCast/fragment.glsl")), null, null, false, true, DepthFunc.Always, 1, 0, BlendFactor.One, BlendFactor.Zero, Vector4.Zero, 0, CullFaceMode.Front);
            ...
            {
                rayCastState[i] = new RenderState(fbufs[i], new ShaderProgram(ShaderSource.Load(ShaderType.VertexShader, "Shaders/FrameBuffer/vertex.glsl"), ShaderSource.Load(ShaderType.FragmentShader, "Shaders/VolumeRayCast/raycast.glsl")), null, null, false, true, DepthFunc.Always, 1, 0, BlendFactor.One, BlendFactor.Zero, Vector4.Zero, 0, CullFaceMode.Back);
